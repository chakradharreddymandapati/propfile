...
public class GithubController {
	...
	@GetMapping("/checkoutCommitId")
	public String checkoutCommitId() throws Exception
	{
		return gitdao.checkoutCommitId();
	}
	
	@GetMapping("/commitHistory")
	public String commitHistory() throws Exception
	{
		return gitdao.commitHistory();
	}
	@GetMapping("/gitCommitedId")
	public String gitCommetedId() throws IOException {
		return gitdao.getCommetedId();
	}
}
